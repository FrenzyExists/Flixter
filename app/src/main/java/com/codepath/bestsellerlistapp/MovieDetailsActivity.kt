...
class MovieDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mMovieVotes = findViewById<TextView>(R.id.textVotes)
        ...
        client[
            ...
            object : JsonHttpResponseHandler() { //connect these callbacks to your API call
                override fun onSuccess(
                    ...
                    mMovieVotes.text = json.jsonObject.get("vote_count").toString()
                    var genre =  json.jsonObject.get("genres") as JSONArray
                    var boi = ""
...
//                    val langThing = json.jsonObject.get("spoken_languages") as JSONArray?
//                    val langFirst = langThing?.get(0)
//                    mMovieLang.text = langThing?.get(3)?.toString() ?:""
